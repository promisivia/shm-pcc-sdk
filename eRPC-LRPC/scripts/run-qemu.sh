...
grep 'LRPC_SHADOW_REGISTERED\|LRPC_CALLBACK_SHADOW_REGISTERED\|DEATHSTAR_GRPC_SHADOW_START\|DEATHSTAR_GRPC_LRPC_RESULT\|DEATHSTAR_GRPC_LRPC_PASS\|LRPC_NESTED_RESULT\|LRPC_NESTED_PASS\|WX_POLICY_PASS\|CALLER_ISOLATION_PASS\|ERPC_LRPC_RESULT\|ERPC_LRPC_PASS\|LRPC_BREAKDOWN_AVG\|UPSTREAM_ERPC_LRPC_RESULT\|UPSTREAM_ERPC_LRPC_LATENCY\|UPSTREAM_ERPC_LRPC_PASS\|ERPC_LRPC_FAIL' "$caller_log"
grep -q 'DEATHSTAR_GRPC_LRPC_PASS' "$caller_log"
grep -q 'LRPC_NESTED_PASS calls=1000 switches=4000 depth=2' "$caller_log"
