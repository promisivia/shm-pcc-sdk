...
// For Tree
using ShermanKey = uint64_t;
using Value = uint64_t;
constexpr ShermanKey kKeyMin = std::numeric_limits<ShermanKey>::min();
constexpr ShermanKey kKeyMax = std::numeric_limits<ShermanKey>::max();
